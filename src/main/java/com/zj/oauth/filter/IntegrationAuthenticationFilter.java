package com.zj.oauth.filter;

import com.zj.oauth.config.IntegrationAuthentication;
import com.zj.oauth.config.IntegrationAuthenticationContext;
...
public class IntegrationAuthenticationFilter extends GenericFilterBean implements ApplicationContextAware {
    ...
    private static final String PLATFORM_PARM_NAME = "client_id";
...
//            integrationAuthentication.setAuthType(request.getParameter(AUTH_TYPE_PARM_NAME)); // 鉴权类型
//            integrationAuthentication.setPlatform(request.getParameter(PLATFORM_PARM_NAME)); // 平台
